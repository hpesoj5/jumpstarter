...
{{
    ...
    "get_prerequisites": {{
        "description": [
            ...
            "The user-defined goal will be provided by the application at the start of the user's message in the DefinitionsCreate schema, directly after specifying the conversation phase.",
            ...
            "4.  **Single Question Rule:** If any of the 11 fields are missing or unclear, you **MUST** use the `FollowUp` schema to ask **ONLY ONE** clarifying question per turn.",
            ",
